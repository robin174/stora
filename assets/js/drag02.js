document.addEventListener("DOMContentLoaded", async () => {
    ...
    const airtableConfig = {
        apiKey: "patBvlQ5rowJjgVUL.594d9f49ab5adfe0a3a4758c59811a0db77f41f6243c85f9df81db3b4a59ff75",
        baseId: "appAVI2KWJ2K4ls6K",
        tableName: "PrototypeV1"
    };
    ...
    async function fetchAirtableData() {
        ...
        return data.records.map(record => ({
            id: record.id,
            provider: record.fields.Name,
            price: record.fields.DataCostStorage,
            type: record.fields.InfoType // e.g., Cloud, Decentralized, etc.
        }));
    }
